...
type VideoService interface {
	...
	ChannelHotList(ctx context.Context, in *RequestChannelHotList, opts ...client.CallOption) (*ResponseChannelHotLists, error)
}
...
func (c *videoService) ChannelHotList(ctx context.Context, in *RequestChannelHotList, opts ...client.CallOption) (*ResponseChannelHotLists, error) {
	req := c.c.NewRequest(c.name, "VideoService.ChannelHotList", in)
	out := new(ResponseChannelHotLists)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type VideoServiceHandler interface {
	...
	ChannelHotList(context.Context, *RequestChannelHotList, *ResponseChannelHotLists) error
}
...
func RegisterVideoServiceHandler(s server.Server, hdlr VideoServiceHandler, opts ...server.HandlerOption) error {
	type videoService interface {
		...
		ChannelHotList(ctx context.Context, in *RequestChannelHotList, out *ResponseChannelHotLists) error
	}
	type VideoService struct {
		videoService
	}
...
func (h *videoServiceHandler) ChannelHotList(ctx context.Context, in *RequestChannelHotList, out *ResponseChannelHotLists) error {
